...
var format_BatasKel_1 = new ol.format.GeoJSON();
var features_BatasKel_1 = format_BatasKel_1.readFeatures(json_BatasKel_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BatasKel_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BatasKel_1.addFeatures(features_BatasKel_1);
var lyr_BatasKel_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BatasKel_1, 
                style: style_BatasKel_1,
                popuplayertitle: "BatasKel",
                interactive: false,
                    title: '<img src="styles/legend/BatasKel_1.png" /> BatasKel'
                });
...
lyr_OSMStandard_0.setVisible(true);lyr_BatasKel_1.setVisible(true);lyr_Pengepul_2.setVisible(true);lyr_TambakKeputih_3.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_BatasKel_1,lyr_Pengepul_2,lyr_TambakKeputih_3];
lyr_BatasKel_1.set('fieldAliases', {'GID_4': 'GID_4', 'GID_0': 'GID_0', 'COUNTRY': 'COUNTRY', 'GID_1': 'GID_1', 'NAME_1': 'NAME_1', 'GID_2': 'GID_2', 'NAME_2': 'NAME_2', 'GID_3': 'GID_3', 'NAME_3': 'NAME_3', 'NAME_4': 'NAME_4', 'VARNAME_4': 'VARNAME_4', 'TYPE_4': 'TYPE_4', 'ENGTYPE_4': 'ENGTYPE_4', 'CC_4': 'CC_4', });
...
lyr_BatasKel_1.set('fieldImages', {'GID_4': 'TextEdit', 'GID_0': 'TextEdit', 'COUNTRY': 'TextEdit', 'GID_1': 'TextEdit', 'NAME_1': 'TextEdit', 'GID_2': 'TextEdit', 'NAME_2': 'TextEdit', 'GID_3': 'TextEdit', 'NAME_3': 'TextEdit', 'NAME_4': 'TextEdit', 'VARNAME_4': 'TextEdit', 'TYPE_4': 'TextEdit', 'ENGTYPE_4': 'TextEdit', 'CC_4': 'TextEdit', });
...
lyr_BatasKel_1.set('fieldLabels', {'GID_4': 'no label', 'GID_0': 'no label', 'COUNTRY': 'no label', 'GID_1': 'no label', 'NAME_1': 'no label', 'GID_2': 'no label', 'NAME_2': 'no label', 'GID_3': 'no label', 'NAME_3': 'no label', 'NAME_4': 'no label', 'VARNAME_4': 'no label', 'TYPE_4': 'no label', 'ENGTYPE_4': 'no label', 'CC_4': 'no label', });
