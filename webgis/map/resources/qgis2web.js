...
map.getView().fit([12551976.400990, -817057.492797, 12567509.400570, -809116.430857], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA INFORMASI TAMBAK DAN PENGEPUL KELURAHAN KEPUTIH</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1605 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Keterangan Layer Tambak Keputih<br />- ID Merupakan kode digitasi<br />- Status Hak Merupakan status hak dari bidang tambak tersebut<br />- Pengelolaa Merupakan jenis sistem pengelolaan dari bidang tambak tersebut<br />- Jenis Budi Merupakan komoditas yang dibudidayakan<br />- Luas (m2) Merupakan luas bidang tambak dalam meter persegi<br />- Luas (Ha) Merupakan luas bidang tambak dalam hektar<br />- Intensif B Merupakan estimasi hasil produksi bandeng apabila menggunakan sistem pengelolaan intensif<br />- Tradisiona Merupakan estimasi hasil produksi bandeng yang seharusnya apabila menggunakan sistem pengelolaan tradisional<br />- Max Banden Merupakan estimasi hasil produksi bandeng tertinggi di keputih dengan menggunakan sistem pengelolaan tradisional<br />- Min Banden Merupakan  estimasi hasil produksi bandeng terendah di keputih dengan menggunakan sistem pengelolaan tradisional<br />- Intensif U Merupakan estimasi hasil produksi udang apabila menggunakan sistem pengelolaan intensif<br />- Tradisiona_1 Merupakan estimasi hasil produksi udang yang seharusnya apabila menggunakan sistem pengelolaan tradisional<br />- Min Udang Merupakan  estimasi hasil produksi udang tertinggi di keputih dengan menggunakan sistem pengelolaan tradisional<br />- Max Udang Merupakan  estimasi hasil produksi udang terendah di keputih dengan menggunakan sistem pengelolaan tradisional<br /><br />Keterangan Layer Pengepul<br />- Name Merupakan nama pengepul<br />- Harga_Udan Merupakan range harga udang terkini<br />- Harga_Band Merupakan range harga bandeng terkini<br />- Pembayaran Merupakan system pembayaran yang tersedia di pengepul<br />- No__Whatsa Merupakan kontak whatsapp pengepul yang bisa dihubungi';
            }
